...
const WECHATY_PUPPET_SERVICE_DISABLE_EVENT_CACHE = () => {
  return process.env['WECHATY_PUPPET_SERVICE_DISABLE_EVENT_CACHE'] === 'true'
}
...
export {
  ...
  WECHATY_PUPPET_SERVICE_DISABLE_EVENT_CACHE,
}
